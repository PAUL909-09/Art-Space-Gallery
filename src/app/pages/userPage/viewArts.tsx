...
//   // Find the corresponding artist dynamically
//   const artist = ARTIST_PROFILE.find((artist) =>
...
//     // Pass only necessary data to ViewArtistProfile
//     const artistData = {
...
//     navigate("/viewArtistProfile", { state: { artistData } });
//     window.scrollTo(0, 0);
//   };
...
//                     <span className="font-semibold">Type:</span> {art.type}
//                   </p>
//                   <p className="text-gray-700 text-lg">
...
//       {/* All Artworks by Artist Section */}
//       {/* {artist && (
//         <motion.section
//           initial={{ opacity: 0, y: 50 }}
//           animate={{ opacity: 1, y: 0 }}
...
//             <h2 className="text-3xl font-bold text-center mb-10">
//               All Artworks by{" "}
//               <span className="text-[#C62A35]">
//                 {artist.Name}
//               </span>
//             </h2>
//             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
//               {artist.ARTIST_DATA.ArtWork.map((art, index) => (
//                 <ArtCardPerArtist key={index} art={{ ...art, artist: artist.Name }} />
//               ))}
//             </div>
//           </div>
//         </motion.section>
...
//             <h2 className="text-3xl font-bold text-center mb-10">
//               Other Artworks by{" "}
//               <span className="text-[#C62A35]">{artist.Name}</span>
//             </h2>
//             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
//               {/* FILTER OUT THE CURRENTLY DISPLAYED ARTWORK */}
//               {artist.ARTIST_DATA.ArtWork.map((artwork, index) => {
//                 // Check if the artwork is the same as the one displayed
//                 if (artwork.title !== art.title) {
//                   return (
//                     <ArtCardPerArtist
//                       key={index}
//                       art={{ ...artwork, artist: artist.Name }}
//                     />
//                   );
//                 }
//                 return null; // Skip rendering if it's the same artwork
//               })}
//             </div>
//           </div>
//         </motion.section>
