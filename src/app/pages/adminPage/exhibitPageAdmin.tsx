        ...
        <div className="container mx-auto px-4">
          ...
          <div className="space-y-12">
            {ExhibitsData.map((exhibit, index) => (
              <div
                key={exhibit.id}
                className={`group flex flex-col md:flex-row ${index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"
                  } items-center bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 transform hover:translate-y-[-5px] hover:shadow-xl`}
              >
                {/* Image Section */}
                <img
                ...
                <div className="p-6 md:w-1/2 flex flex-col justify-between">
                  <div>
                    <div className="flex items-center justify-end mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      {/* Views Button (Hidden by default, appears on hover) */}
                      <button
                      ...
                      >
                        ...
                        <span>{exhibit.views >= 1000 ? `${(exhibit.views / 1000).toFixed(1)}k` : exhibit.views}</span>
                      </button>
                    </div>
...
export default ExhibitPageAdmin;
