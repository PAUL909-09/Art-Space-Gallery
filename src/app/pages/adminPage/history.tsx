            ...
            <main className="flex-grow flex items-center justify-center px-6 py-16 mt-16">
                <div className="bg-white text-black rounded-xl shadow-lg max-w-4xl w-full p-6">
                    <section className="mb-8">
                        <h2 className="text-xl font-bold mb-6 text-gray-800">Today</h2>
                        {ArtisyImage.map((artist, index) => (
                            ...
                            >
                                ...
                                {/* Action */}
                                <p className="flex  ml-8 text-gray-700 text-sm">
                                    Added a new art piece
                                </p>
                                <p className="text-sm text-gray-500">Jan 19, 2025</p>
                                <button className="ml-6 bg-red-500 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-red-600 transition">
                                    Delete
                                </button>
                            </div>
                        ))}
