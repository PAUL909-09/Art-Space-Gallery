...
//             facebook={artist.Facebook}
//             description={artist.Description}
//             onViewProfile={() => handleViewArtistProfile(artist)} artisttype={""}          />
//         ))}
//       </div>
//     </section>
//   );
...
// export default FeaturedArtistArtist;
import { ARTIST_PROFILE } from "../../config/config";
import ArtistProfileCard from "../../components/Cards/ArtistProfileCard";
import { useNavigate } from "react-router-dom";
import { useEffect } from "react";

const FeaturedArtistAdmin = () => {
  const navigate = useNavigate();
...
export default FeaturedArtistAdmin;
