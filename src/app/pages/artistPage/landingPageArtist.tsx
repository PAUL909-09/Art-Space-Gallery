...
// const LandingPageArtist: React.FC = () => {
...
//   const visibleArtists = ARTIST_PROFILE.slice(startIndex, endIndex);
...
//   const [backgroundIndex, setBackgroundIndex] = useState(0); // ✅ Initialize with 0
...
//       {/* Hero Banner */}
//       <motion.section
//         className="relative bg-cover bg-center text-white py-20 px-5 sm:py-28 lg:py-36 flex items-center justify-center transition-all duration-1000 ease-in-out"
//         style={{
//           backgroundImage: `url(${LandingPageImage[backgroundIndex].src})`,
//           height: "90vh",
...
//         >
//           <motion.div
//             className="bg-black bg-opacity-50 p-8 rounded-lg w-1/2 text-left ml-10 shadow-2xl"
//             whileHover={{ scale: 1.05 }} // ✅ Smooth scale-up on hover
//             initial={{ opacity: 0, y: 20 }} // ✅ Fade-in effect
//             animate={{ opacity: 1, y: 0 }} // ✅ Smooth transition in
...
//       {/* Artists */}
//       <section className="relative min-h-screen bg-red-90 py-16 px-5 backdrop-blur-md">
//         {/* Header Section */}
